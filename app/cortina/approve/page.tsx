...
import { fetchNavigation, fetchFooter } from "@/api/fetch";
...
export default async function CortinaApprovePage({ searchParams }: PageProps) {
  const { submission, signature, expires } = searchParams;
