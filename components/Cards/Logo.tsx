...
export default function CardLogo({
  ...
  return (
    <div
      ref={ref}
      className={cx(
        "group rounded-3xl shadow-card overflow-hidden w-full p-3 bg-white",
        className
      )}
    >
      <div className="flex gap-4 justify-between">
        <div className="flex items-center gap-5">
          <div className="group transition-all w-[56px] h-[56px] overflow-hidden rounded-[9px]">
            <Image
              alt={title}
              src={image}
              className={cx(
          ...
          <div className="flex items-center justify-between">
            <h3
              ...
              className={cx(
                "text-2xl text-black font-bold line-clamp-2 md:group-hover:text-green-800",
